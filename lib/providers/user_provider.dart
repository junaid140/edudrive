...
class UserProvider with ChangeNotifier {
  ...
  Future<void> fetchUserDetails() async {
    try {
      // final url = '${DBUrls.users}/${firebase.FirebaseAuth.instance.currentUser!.uid}.json?auth=$authToken';
      final response = await firestoreServices.getParent(firebase.FirebaseAuth.instance.currentUser!.uid);
