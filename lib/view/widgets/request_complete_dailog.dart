...
class ResquestCompleteDailog extends StatelessWidget {
  final String paymentMethod ;
  final double fareAmount;
   ResquestCompleteDailog({Key? key, required this.fareAmount, required this.paymentMethod}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text("Ride Completed Success fully",style: FontAssets.mediumText.copyWith(color: Colors.black),),
                  SizedBox(
                    height: 20,
                  ),
                  Divider(),
