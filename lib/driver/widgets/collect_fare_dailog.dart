import 'package:edudrive/driver/providers/maps_provider.dart';
                    ...
                    children: [
                      ...
                      ElevatedButton(
                          ...
                          onPressed: ()async{
                            ...
                            Navigator.pop(context);
                            await Provider.of<MapsProvider1>(context, listen: false).goOnline();
                            ...
                            child: Text("Collect Cash Button"),
                          )),
                    ],
                  ),
                ],
